...
- Solution URL: [Solution URL](https://github.com/nishanth1596/faq-accordion)
- Live Site URL: [Live site URL](https://nishanth-faq-accordion.netlify.app/)
...
1. Clone this repository:
   ...
   ```bash
   git clone https://github.com/nishanth1596/faq-accordion.git
   ```
...
Google Fonts - I used the Work Sans fonts from Google Fonts to style the text.
